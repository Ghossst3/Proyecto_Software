...
def dashboard():
    ...
    # Aquí puedes pasar datos según el rol
...
# Roles que pueden acceder al módulo de usuarios
ROLES_ADMIN = ['dueño', 'encargado_mostrador']
 
def puede_administrar():
    """Verifica si el usuario en sesión puede administrar cuentas."""
    return session.get('user_rol') in ROLES_ADMIN
